...
class BeamSearch(object):
    ...
    def apply(self, visual: utils.TensorOrSequence, visual_gl: utils.TensorOrSequence,out_size=1, return_probs=False, **kwargs):
        ...
        with self.model.statefulness(self.b_s):
            for t in range(self.max_len):
                visual, outputs = self.iter(t, visual,visual_gl, outputs, return_probs, **kwargs)
    ...
    def iter(self, t: int, visual: utils.TensorOrSequence,visual_gl:utils.TensorOrSequence,outputs, return_probs, **kwargs):
